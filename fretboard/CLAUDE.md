...
Renderer for the movable scale fingerings (JGTH pp. 6–9 so far).
...
- Transcribed: major (p. 7), dorian and mixolydian (p. 9) — the same six fingering
  identities (I/M/P × 6th/5th-string root) in all three.
...
headlessly: all shapes × 12 keys × 3 scales are in-scale, cover every degree, and read
...
## Not yet transcribed
Harmonic minor, melodic minor, Phrygian dominant (p. 13, dots only — no fingers),
